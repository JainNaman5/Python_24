...
questions = [
    ("What is the latest processor of Snapdragon for Laptop?", "Snapdragon X Elite"),
    ("What is the latest processor of Snapdragon for Mobile?", "Snapdragon 8 Gen 1"),
    ("What are the latest generations of CPUs offered by Intel?", "14th Gen"),
    ("What is the latest version of macOS?", "macOS 14 Sonoma"),
    ("What is the latest version of Windows?", "Windows 11"),
    ("What is the most commonly used OS ?", "Windows")
]
